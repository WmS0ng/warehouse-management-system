...
public class TokenUtils {
    ...
    private String sign(CurrentUser currentUser, String securityKey) {
        String token = JWT.create()
                ...
                .withIssuedAt(new Date())// jwt token的颁发时间
                .withExpiresAt(new Date(System.currentTimeMillis() + expireTime * 1000L))// 过期时间
                .sign(Algorithm.HMAC256(securityKey)); // 指定签名 -- 密钥为用户密码
        return token;
    }
